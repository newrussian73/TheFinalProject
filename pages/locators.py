...
class LoginPageLocators():
    ...
    LOGIN_REGISTRATION = (By.NAME, 'registration-email')
    PASSWORD_REGISTRATION = (By.NAME, 'registration-password1')
    R_PASSWORD_REGISTRATION = (By.NAME, 'registration-password2')
